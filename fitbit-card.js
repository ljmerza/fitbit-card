...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FitbitCardEditor; });
...
class FitbitCardEditor extends lit_element__WEBPACK_IMPORTED_MODULE_0__["LitElement"] {
    static get styles() {
    ...
    render() {
        ...
        return lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]`
            <div class="card-config">
                ...
                <div class='entities'>
                <h3>Header Entities ${this.disableHeaderOptions ? lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]`<span class='header-max'>&nbsp;(Max 3 Entities)</span>` : ``}</h3>
...
customElements.define('fitbit-card-editor', _index_editor__WEBPACK_IMPORTED_MODULE_3__["default"]);


class FitbitCard extends lit_element__WEBPACK_IMPORTED_MODULE_0__["LitElement"] {
  static get properties() {
    return {
      hass: Object,
      config: Object,
 ...
 */
   ...
   */
  getStatus() {
    if (!this.config.battery_entity && !this.config.title) return lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]``;
    ...
    if (batteryEntity.attributes.icon) {
      ...
      batteryIcon = lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]`<ha-icon icon="${batteryEntity.attributes.icon}" style="color:${iconColor}"></ha-icon>`;
    }
  ...
  getHeaderSensor(entity) {
    if (!entity) return lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]``;
...
class FitbitProgressRing extends lit_element__WEBPACK_IMPORTED_MODULE_0__["LitElement"] {
  static get properties() {
    return {
      radius: String,
      stroke: String,
...
/******/ });
//# sourceMappingURL=fitbit-card.js.map